...
from sognet.rpn.generate_anchors import get_field_of_anchors, compute_targets, unmap
from sognet.bbox.bbox_transform import bbox_overlaps
import pickle
...
def add_rpn_blobs(blobs, im_scales, roidb):
    ...
    # ]
    valid_keys = [
        'boxes', 'segms', 'matched_segms', 'seg_areas', 'gt_classes',
